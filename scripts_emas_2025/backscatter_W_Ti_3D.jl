...
model = NExt.epma_model(eq, (-1500.0u"nm", 0.0u"nm", -1500u"nm", 1500u"nm", -1500u"nm", 1500u"nm"), (50, 70, 70), 13)
...
function mass_concentrations(e, x_, to_nm)
    ...
    if sqrt((x-700u"nm")^2 + (y-700u"nm")^2 + (z-100u"nm")^2) < 400u"nm"
        return e == 1 ? dimless(mat[2].density, eq.dim_basis) : 0.0
    elseif sqrt(x^2 + (y+700u"nm")^2) < 500u"nm"
        return e == 2 ? dimless(mat[3].density, eq.dim_basis) : 0.0
    else
        return e == 3 ? dimless(mat[1].density, eq.dim_basis) : 0.0
    end
end
...
heatmap(range(-700u"nm", 700u"nm", 70), range(-700u"nm", 700u"nm", 70), reshape(-outflx ./ inflx, (70, 70)), color=:grays, colorbar=true, aspect_ratio=:equal)
surface(reshape(outflx, (70, 70)), color=:grays)
savefig("backscatter3D.png")
