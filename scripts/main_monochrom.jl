...
space_model = EPMAfem.SpaceModels.GridapSpaceModel(CartesianDiscreteModel((-0.5, 0.5, 0, 0.5), (30, 30)))
...
print(func_left)
print((z, x) -> func_left(VectorValue(x, z)))
...
p1 = Plots.contourf(-0.5:0.001:0.5, 0:0.001:0.5, (x,z) -> func_left(VectorValue(x, z)), cmap=:grays, aspect_ratio=:equal)
