...
function assemble_bilinear(integral::IntFuncIntegral, model::AbstractHarmonicsModel{D}, U, V, quad::NSphericalQuadrature{D}=LebedevQuadrature{Ð}()) where {D}
...
function assemble_bilinear(integral::∫∫S²_kuv, model::AbstractHarmonicsModel{D}, U, V, quad::NSphericalQuadrature{D}=LebedevQuadrature{D}()) where {D}
